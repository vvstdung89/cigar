(function (wHandle, wjQuery) {
    var CONNECTION_URL = "gs.cryptocombat.incognito.corncob.dev", // Default Connection
    ...
    function drawLeaderBoard() {
        ...
        if (drawTeam || 0 != leaderBoard.length)
            if (drawTeam || showName) {
                ...
                var scaleFactor = Math.min(0.22 * canvasHeight, Math.min(200, 0.3 * canvasWidth)) * 0.005;
    ...
    Cell.prototype = {
        ...
        drawOneCell: function (ctx) {
            if (this.shouldRender()) {
                var bot = (this.name == "%prv%" || this.name == "%btc%")
                ...
                if (!bot && (showColor || 15 < this.size) && !b) {
